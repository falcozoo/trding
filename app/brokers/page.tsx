...
export default function BrokersPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-12">
      ...
      {/* Best brokers by country — geo internal link grid */}
      <section className="mt-14">
        <h2 className="text-2xl font-bold">Best brokers by country</h2>
        <p className="mt-2 max-w-3xl text-muted">
          Trading rules, regulators and payment options differ by market. These
          country guides rank the same brokers with local regulation and
          practical notes for where you live.
        </p>
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {COUNTRIES.map((c) => (
            <Link
